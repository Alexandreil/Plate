...
num = 1
plt0 = Button(root, text = num, width = 7, height = 3, bg = "#E3E0D5", command =  click0)
plt1 = Button(root, text = num + 1, width = 7, height = 3, bg = "#E3E0D5", command =  click1)
plt2 = Button(root, text = num + 2, width = 7, height = 3, bg = "#E3E0D5", command =  click2)
plt3 = Button(root, text = num + 3, width = 7, height = 3, bg = "#E3E0D5", command =  click3)
plt4 = Button(root, text = num + 4, width = 7, height = 3, bg = "#E3E0D5", command =  click4)
plt5 = Button(root, text = num + 5, width = 7, height = 3, bg = "#E3E0D5", command =  click5)
plt6 = Button(root, text = num + 6, width = 7, height = 3, bg = "#E3E0D5", command =  click6)
plt7 = Button(root, text = num + 7, width = 7, height = 3, bg = "#E3E0D5", command =  click7)
plt8 = Button(root, text = num + 8, width = 7, height = 3, bg = "#E3E0D5", command =  click8)
plt9 = Button(root, text = num + 9, width = 7, height = 3, bg = "#E3E0D5", command =  click9)
plt10 = Button(root, text = num + 10, width = 7, height = 3, bg = "#E3E0D5", command =  click10)
plt11 = Button(root, text = num + 11, width = 7, height = 3, bg = "#E3E0D5", command =  click11)
plt12 = Button(root, text = num + 12, width = 7, height = 3, bg = "#E3E0D5", command =  click12)
plt13 = Button(root, text = num + 13, width = 7, height = 3, bg = "#E3E0D5", command =  click13)
plt14 = Button(root, text = num + 14, width = 7, height = 3, bg = "#E3E0D5", command =  click14)
plt15 = Button(root, text = num + 15, width = 7, height = 3, bg = "#E3E0D5", command =  click15)
plt16 = Button(root, text = num + 16, width = 7, height = 3, bg = "#E3E0D5", command =  click16)
plt17 = Button(root, text = num + 17, width = 7, height = 3, bg = "#E3E0D5", command =  click17)
plt18 = Button(root, text = num + 18, width = 7, height = 3, bg = "#E3E0D5", command =  click18)
plt19 = Button(root, text = num + 19, width = 7, height = 3, bg = "#E3E0D5", command =  click19)
plt20 = Button(root, text = num + 20, width = 7, height = 3, bg = "#E3E0D5", command =  click20)
plt21 = Button(root, text = num + 21, width = 7, height = 3, bg = "#E3E0D5", command =  click21)
plt22 = Button(root, text = num + 22, width = 7, height = 3, bg = "#E3E0D5", command =  click22)
plt23 = Button(root, text = num + 23, width = 7, height = 3, bg = "#E3E0D5", command =  click23)
plt24 = Button(root, text = num + 24, width = 7, height = 3, bg = "#E3E0D5", command =  click24)
plt25 = Button(root, text = num + 25, width = 7, height = 3, bg = "#E3E0D5", command =  click25)
plt26 = Button(root, text = num + 26, width = 7, height = 3, bg = "#E3E0D5", command =  click26)
plt27 = Button(root, text = num + 27, width = 7, height = 3, bg = "#E3E0D5", command =  click27)
plt28 = Button(root, text = num + 28, width = 7, height = 3, bg = "#E3E0D5", command =  click28)
plt29 = Button(root, text = num + 29, width = 7, height = 3, bg = "#E3E0D5", command =  click29)
plt30 = Button(root, text = num + 30, width = 7, height = 3, bg = "#E3E0D5", command =  click30)
plt31 = Button(root, text = num + 31, width = 7, height = 3, bg = "#E3E0D5", command =  click31)

plt32 = Button(root, text = "( ͡° ͜ʖ ͡°)", width = 7, height = 3, bg = "#E3E0D5")
plt33 = Button(root, text = "^ↀᴥↀ^", width = 7, height = 3, bg = "#E3E0D5")
plt34 = Button(root, text = "¯\_(ツ)_/¯", width = 7, height = 3, bg = "#E3E0D5")
plt35 = Button(root, text = "(ง ͠° ͟ل͜ ͡°)ง", width = 7, height = 3, bg = "#E3E0D5")
plt36 = Button(root, text = "ʕ•ᴥ•ʔ", width = 7, height = 3, bg = "#E3E0D5")
...
plt41 = Button(root, text = "-_-", width = 7, height = 3, bg = "#E3E0D5")
plt42 = Button(root, text = "(ᵔᴥᵔ)", width = 7, height = 3, bg = "#E3E0D5")
plt43 = Button(root, text = "(ಥ﹏ಥ)", width = 7, height = 3, bg = "#E3E0D5")
plt44 = Button(root, text = "ᕦ(ò_óˇ)ᕤ", width = 7, height = 3, bg = "#E3E0D5")
plt45 = Button(root, text = "┌( ಠ_ಠ)┘", width = 7, height = 3, bg = "#E3E0D5")
plt46 = Button(root, text = "(ಠ_ಠ)", width = 7, height = 3, bg = "#E3E0D5")
plt47 = Button(root, text = "◘_◘", width = 7, height = 3, bg = "#E3E0D5")
plt48 = Button(root, text = "ب_ب", width = 7, height = 3, bg = "#E3E0D5")
plt49 = Button(root, text = "ಠoಠ", width = 7, height = 3, bg = "#E3E0D5")
plt50 = Button(root, text = "◉◡◉", width = 7, height = 3, bg = "#E3E0D5")
plt51 = Button(root, text = "(◑‿◐)", width = 7, height = 3, bg = "#E3E0D5")
plt52 = Button(root, text = "◉_◉", width = 7, height = 3, bg = "#E3E0D5")
plt53 = Button(root, text = "(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧", width = 7, height = 3, bg = "#E3E0D5")
plt54 = Button(root, text = "(づ｡◕‿‿◕｡)づ", width = 7, height = 3, bg = "#E3E0D5")
plt55 = Button(root, text = "┌༼◉ل͟◉༽┐", width = 7, height = 3, bg = "#E3E0D5")
plt56 = Button(root, text = "ᕦ༼◣_◢༽つ", width = 7, height = 3, bg = "#E3E0D5")
plt57 = Button(root, text = "୧( ಠ┏ل͜┓ಠ )୨", width = 7, height = 3, bg = "#E3E0D5")
plt58 = Button(root, text = "໒( ⊚ (oo) ⊚ )७", width = 7, height = 3, bg = "#E3E0D5")
plt59 = Button(root, text = "( ･_･)♡", width = 7, height = 3, bg = "#E3E0D5")
plt60 = Button(root, text = "╭∩╮(ಠಠ)╭∩╮", width = 7, height = 3, bg = "#E3E0D5")
plt61 = Button(root, text = "ʕ⊙ᴥ⊙ʔ", width = 7, height = 3, bg = "#E3E0D5")
plt62 = Button(root, text = "o(╥﹏╥)o", width = 7, height = 3, bg = "#E3E0D5")
